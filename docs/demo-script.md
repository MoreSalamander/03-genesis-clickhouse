...
| Time | On screen | Say |
|---|---|---|
| 0:00–0:15 | Masthead + corpus strip: **4.35M audience rows, 367k production events, 62 projects**. LIVE badges. | "Ten years of a film studio's history — four and a half million rows of it — and one question every studio gets wrong: what does our own past actually prove? This is Institutional Intelligence, built for the ClickHouse track." |
...
| 1:05–1:40 | Findings: **✓ VERIFIED** (n=1,021,186; effect/noise 231) and **⚠ CONTESTED** sequel economics. | "Now the part no chatbot does: verification is computed in code, never asserted by the model. A million-row completion-rate effect: VERIFIED. Sequel economics? The corpus disagrees with itself — premium in one slicing, fatigue in another — so the system says CONTESTED and preserves both." |
