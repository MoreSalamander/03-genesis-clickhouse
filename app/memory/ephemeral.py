...
Short-lived cross-process coordination only, never a knowledge layer: the
investigation latch keeps two investigations from racing the same analytical
context (acquire BEFORE persisting — the phantom-investigation lesson from 02).
"""
...
INVESTIGATION_LATCH = "genesis:institutional:investigation:active"
LATCH_TTL_S = 1800  # analytical investigations run longer than ops loops
